...
- Path: kataw8/test\__snapshot__\parser\misc\destructuring\destructuring-assignment-negative-tests\gen\variable_in_for_of
> :: test: variable in for of
> :: case: [this]
## Input

`````js
var x, y, z; for (x of [this] = {});
`````
## Output
...
```javascript
{
    ...
    "isModule": false,
    "source": "var x, y, z; for (x of [this] = {});",
    "fileName": "__root__",
    "flags": 0,
    "start": 0,
    "end": 36
