...
([x / 2]());
 () => a;
([x / 2]());
({ a: ("\"string\"") / a3((a /= [ (c) => a] = ([x / 2]()))) });
({ a: ("\"string\"") / a3((a /= [b.c] = ([x / 2]()))) });
a;
(({ a: ("\"string\"") / a3((a /= [b.c] = ([x / 2]()))) }) = a);
```
...
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 135, end: 160
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 134, end: 160
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 133, end: 160
...
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 198, end: 230
...
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 263, end: 275
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 262, end: 275
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 261, end: 275
...
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 325, end: 336
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 324, end: 336
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 323, end: 336
✖ ',' expected - start: 336, end: 339
✖ ',' expected - start: 336, end: 339
...
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 391, end: 404
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 390, end: 404
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 389, end: 404
✖ ',' expected - start: 404, end: 407
✖ ',' expected - start: 404, end: 407
...
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 459, end: 472
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 458, end: 472
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 457, end: 472
✖ ',' expected - start: 472, end: 475
✖ ',' expected - start: 472, end: 475
...
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 567, end: 630
