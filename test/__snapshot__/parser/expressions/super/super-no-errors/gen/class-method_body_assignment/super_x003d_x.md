...
- Path: kataw8/test\__snapshot__\parser\expressions\super\super-no-errors\gen\class-method_body_assignment
...
```javascript
✖ 'super' must be followed by an argument list or member access. - start: 19, end: 27
