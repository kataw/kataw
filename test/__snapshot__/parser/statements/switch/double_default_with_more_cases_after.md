...
```javascript
✖ A 'default' clause cannot appear more than once in a 'switch' statement. - start: 29, end: 34
✖ A 'default' clause cannot appear more than once in a 'switch' statement. - start: 44, end: 49
