...
```javascript
{
    ...
    "isModule": false,
    "text": "switch( )=)=(){{}/()try finally catch /1/ case",
    "fileName": "__root__",
    "flags": 0,
    "start": 0,
    "end": 46
...
@{x2716}@ Expression expected - start: 41, end: 46
@{x2716}@ Unexpected token. - start: 41, end: 46
@{x2716}@ Statement expected - start: 41, end: 46
