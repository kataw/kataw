...
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 70, end: 90
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 69, end: 90
