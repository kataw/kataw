...
✖ An member access expression should take an argument. - start: 57, end: 62
✖ Identifier expected - start: 61, end: 62
✖ An member access expression should take an argument. - start: 57, end: 64
✖ Identifier expected - start: 63, end: 64
✖ The parser expected to find a '}' to match the '{' token here - start: 78, end: 79
...
✖ Declaration or statement expected - start: 95, end: 98
