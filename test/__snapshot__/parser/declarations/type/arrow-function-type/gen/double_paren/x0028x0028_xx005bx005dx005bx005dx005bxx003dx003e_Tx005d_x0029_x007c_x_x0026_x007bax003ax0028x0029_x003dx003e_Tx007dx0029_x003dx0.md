...
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 11, end: 50
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 10, end: 50
✖ Arrow parameters can only contain a binding pattern or an identifier - start: 8, end: 50
