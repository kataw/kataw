...
`````js
'use strict'; var x, y, z; for ([50] in {});
`````
## Output
...
```javascript
{
    ...
    "isModule": false,
    "source": "'use strict'; var x, y, z; for ([50] in {});",
    "fileName": "__root__",
    "flags": 0,
    "start": 0,
    "end": 44
...
```javascript
✖ The left-hand side of a 'for...in' statement must be a variable or a property access. - start: 39, end: 41
