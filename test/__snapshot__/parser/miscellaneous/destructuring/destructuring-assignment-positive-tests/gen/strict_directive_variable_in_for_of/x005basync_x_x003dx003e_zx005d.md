...
`````js
'use strict'; var x, y, z; for ([async x => z] of {});
`````
## Output
...
```javascript
{
    ...
    "isModule": false,
    "source": "'use strict'; var x, y, z; for ([async x => z] of {});",
    "fileName": "__root__",
    "flags": 0,
    "start": 0,
    "end": 54
...
```javascript
✖ The left-hand side of a 'for...of' statement must be a variable or a property access. - start: 49, end: 51
