...
`````js
'use strict'; let x, y, z; for (x in x = [ ...([a]) ] = z = {});
`````
## Output
...
```javascript
{
    ...
    "isModule": false,
    "source": "'use strict'; let x, y, z; for (x in x = [ ...([a]) ] = z = {});",
    "fileName": "__root__",
    "flags": 0,
    "start": 0,
    "end": 64
...
```javascript
✖ The left-hand side must be a variable or a property access. - start: 53, end: 55
