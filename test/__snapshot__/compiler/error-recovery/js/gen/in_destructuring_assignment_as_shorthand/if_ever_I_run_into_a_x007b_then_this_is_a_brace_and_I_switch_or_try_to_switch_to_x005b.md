...
`````js
[ if ever I run into a {, then this is a brace and I switch or try to switch to [ ] = x
`````
...
{
    "kind": 2243,
    "source": "[ if ever I run into a {, then this is a brace and I switch or try to switch to [ ] = x",
    "filename": "",
    "statements": [
        {
            "kind": 2097233,
