...
- Path: kataw_dev\test\__snapshot__\compiler\js\statements\labelled\gen\unclosed_parens
...
{
    "kind": 196,
    "source": "try( =! class function try while with foo!",
    "filename": "",
    "scriptBody": {
        "kind": 197,
        "statements": [
...
```javascript
✖ Identifier expected - start: 56, end: 0
✖ Identifier expected - start: 88, end: 0
