...
```javascript
✖ In non-strict mode code, functions can only be declared at top level, inside a block, or as the body of an if statement - start: 101, end: 0
✖ Identifier expected - start: 110, end: 0
✖ Identifier expected - start: 154, end: 0
