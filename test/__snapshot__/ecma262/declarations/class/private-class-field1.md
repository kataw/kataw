...
class C {
  ...
  test(other: C) {
    other.#q;
  } // in lexical scope, object has the property.
}
class Outer {
  #outer: number;
  constructor() {
    var Inner = class A {
      ...
      constructor() {
        ...
        x.#outer = 0; // Both inner and outer should be visible here!
        x.#inner = new Outer();
      } // Error, #inner is not a private field of Outer
    };
  }
}

class Annotations {
  // Private class fields must either be annotated or have an initializer#p: number;;
  #q = 0;;
  #r;;
  #s: string = 0;; // Error, number ~> string
  #t: string = "\"yay!\"";;
