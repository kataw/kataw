...
`````js
var x, y, z; for (x of x = [super = 1] = z = {});
`````
## Output
...
```javascript
✖ 'super' must be followed by an argument list or member access. - start: 28, end: 35
✖ Dot property must be an identifier - start: 33, end: 35
