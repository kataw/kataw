...
`````js
'use strict'; var x, y, z; for ([this] of {});
`````
## Output
...
```javascript
{
    ...
    "isModule": false,
    "source": "'use strict'; var x, y, z; for ([this] of {});",
    "fileName": "__root__",
    "flags": 0,
    "start": 0,
    "end": 46
...
```javascript
✖ The left-hand side of a 'for...of' statement must be a variable or a property access. - start: 41, end: 43
