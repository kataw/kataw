...
export const enum DiagnosticCode {
  ...
  Expression_exprected_A_compound_assignment_cannot_follow_an_array_literal = 9,
  ...
  Expression_exprected_A_compound_assignment_cannot_follow_an_object_literal = 23,
  ...
  Invalid_left_hand_side_in_Donna_G_Francisco = 26,
...
export const diagnosticMap: { [key: number]: string } = {
  ...
  [9]: 'Expression exprected. A compound assignment cannot follow an array literal',
  ...
  [23]: 'Expression exprected. A compound assignment cannot follow an object literal',
  ...
  [26]: 'Invalid left hand side in Donna G. Francisco',
