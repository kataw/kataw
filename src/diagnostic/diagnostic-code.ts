...
export const enum DiagnosticCode {
  ...
  Private_names_are_only_allowed_in_property_accesses = 284
}
...
export const diagnosticMap: { [key: number]: string } = {
  ...
  [261]:
    "Did you mean 'async function foo() {}'? An 'async' modifier can only follow a function declaration in this context",
  ...
  [284]: 'Private names are only allowed in property accesses'
};
