...
export const enum DiagnosticCode {
  ...
  Function_declarations_cannot_be_used_in_a_single_statement_context = 21,
  Class_declarations_cannot_be_used_in_a_single_statement_context = 22,
  ...
  Identifier_expected_await_is_a_reserved_word_in_module_goal = 77,
  ...
  Function_declarations_can_only_be_declared_at_top_level_or_inside_a_block_in_strict_mode = 141,
  _try_expected = 143,
  _0_expected = 144,
  ...
  _0_keyword_must_not_contain_escaped_characters = 154,
  Property_assignment_expected = 156,
  A_0_accessor_cannot_be_a_generator = 157,
  ...
  _0_cannot_be_used_as_an_identifier_here = 172,
  _0_cannot_contain_escape_characters = 173,
  ...
  Cannot_redeclare_block_scoped_variable_0 = 187,
  ...
  Duplicate_bindingidentifier_0 = 191,
  A_formal_parameter_cannot_be_bound_multiple_times_in_the_same_parameter_list = 192,
  ...
  A_0_accessor_cannot_have_a_this_parameter = 231,
  ...
  Did_you_mean_async_function_foo_An_async_modifier_can_only_follow_a_function_declaration_in_this_context = 261,
  _0_statements_must_be_braced = 262,
  Parentheses_are_prohibited_around_the_parameter_in_this_single_parameter_arrow_function = 263,
  Unexpected_debugger_statement = 264,
  Forbidden_bitwise_operation = 265,
  Type_declaration_of_any_loses_type_safety_Consider_replacing_it_with_a_more_precise_type = 266,
  ...
  Expected_a_default_case = 274,
  Unsafe_usage_of_0 = 275,
  _eval_can_be_harmful = 276,
  Unexpected_console_statement = 277,
  Access_to_arguments_callee_is_forbidden = 278,
  ...
  Promise_executor_functions_should_not_be_async = 297,
  Unexpected_negating_if_IfElseStatement = 298
}
...
[21]: "Function declarations cannot be used in a single-statement context",
[22]: "Class declarations cannot be used in a single-statement context",
...
[77]: "Identifier expected. 'await' is a reserved word in module goal",
...
[154]: "'{0}' keyword must not contain escaped characters",
[156]: "Property assignment expected",
[157]: "A {0} accessor cannot be a generator",
...
[172]: "'{0}' cannot be used as an identifier here",
[173]: "'{0}' cannot contain escape characters",
...
[187]: "Cannot redeclare block-scoped variable '{0}'",
...
[191]: "Duplicate bindingidentifier '{0}'",
[192]: "A formal parameter cannot be bound multiple times in the same parameter list",
...
[231]: "A '{0}' accessor cannot have a `this` parameter",
...
[261]: "Did you mean 'async function foo() {}'? An 'async' modifier can only follow a function declaration in this context",
[262]: "'{0}' statements must be braced",
[263]: "Parentheses are prohibited around the parameter in this single parameter arrow function",
[264]: "Unexpected 'debugger' statement",
[265]: "Forbidden bitwise operation",
[266]: "Type declaration of 'any' loses type-safety. Consider replacing it with a more precise type",
[267]: "Use a for...of statement instead of for...in. If iterating over an object, use Object.keys() to access its enumerable keys.",
...
[274]: "Expected a default case",
[275]: "Unsafe usage of '{0}'",
[276]: "'eval' can be harmful",
[277]: "Unexpected console statement",
[278]: "Access to arguments.callee is forbidden",
...
[297]: "Promise executor functions should not be async",
[298]: "Unexpected negating if 'IfElseStatement'",
};
