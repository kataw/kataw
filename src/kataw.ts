...
import { PrinterOptions, printSource } from './printer/index';
...
export { createObjectTypeCallProperty } from './ast/types/object-type-call-property';
export { createObjectTypeIndexer } from './ast/types/object-type-indexer';
