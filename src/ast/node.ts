...
export const enum NodeKind {
  ...
  CanNotBreakeObjectPattern = 1 << 14,
  ...
  IsMemberExpression = 1 << 26,
  IsUntionTypeIndention = 1 << 27,
  IsDeclarationBindingElement = 1 << 28,
  IsCallExpression = 1 << 30,
  IsObjectType = 1 << 29,
  AnyKeyword = 2 | IsChildless | IsTypescript,
  ArgumentList = 3,
  ArrayAssignmentPattern = 4,
  ArrayBindingPattern = 5 | IsBindingPattern,
  ArrayLiteral = 6 | IsArrayOrObjectLiteral | IsExpression | IsLeftHandSideExpression,
  ArrayType = 7 | IsTypescript,
  ArrowFunction = 8 | IsExpression | IsBlockScope | CanNotBreakeObjectPattern,
  ArrowParameters = 9 | IsExpression | CanNotBreakeObjectPattern,
  ...
  AsyncArrowFunction = 16 | IsExpression | CanNotBreakeObjectPattern,
  ...
  BindingElement = 28 | CanNotBreakeObjectPattern,
  ...
  CallChain = 42 | IsExpression | IsCallExpression,
  CallExpression = 43 | IsExpression | IsLeftHandSideExpression | IsCallExpression,
  ...
  ClassElement = 49,
  ClassElementList = 50,
  ClassExpression = 51 | IsExpression | IsLeftHandSideExpression,
  ClassHeritage = 52,
  ClassProperty = 53,
  ...
  ElementAccessChain = 67 | IsExpression | IsMemberExpression,
  ElementAccessExpression = 68 | IsExpression | IsLeftHandSideExpression | IsMemberExpression,
  ...
  FieldDefinition = 84 | CanNotBreakeObjectPattern,
  ForBinding = 85 | CanNotBreakeObjectPattern,
  ...
  FormalParameter = 89 | CanNotBreakeObjectPattern,
  ...
  GeneratorMethod = 98 | IsGenerator | IsBlockScope | IsMethod | CanNotBreakeObjectPattern,
  HTMLClose = 99,
  HTMLOpen = 100,
  ...
  JsxTagNamePropertyAccess = 136 | IsMemberExpression,
  JsxText = 137,
  LabelIdentifier = 138,
  LabelledIdentifier = 139 | IsIdentifier,
  LabelledStatement = 140 | IsStatement,
  LexicalBinding = 141 | CanNotBreakeObjectPattern,
  ...
  NamedExports = 152,
  NamedImports = 153,
  NamedTupleMember = 154 | IsTypescript | IsUntionTypeIndention,
  ...
  ObjectLiteral = 168 | IsArrayOrObjectLiteral | IsExpression | IsLeftHandSideExpression,
  ObjectTypeMembers = 169 | IsObjectType,
  OmittedExpression = 170 | IsChildless | IsExpression | CanNotBreakeObjectPattern,
  OptionalChain = 171 | IsExpression,
  OptionalExpression = 172 | IsExpression,
  OptionalType = 173 | IsTypescript,
  ParameterDeclaration = 174 | IsTypescript | IsUntionTypeIndention,
  Parameters = 175 | IsTypescript | IsUntionTypeIndention,
  ...
  PropertyAccessChain = 183 | IsExpression | IsMemberExpression,
  PropertyAccessExpression = 184 | IsExpression | IsLeftHandSideExpression | IsMemberExpression,
  ...
  TupleType = 224 | IsTypescript | IsUntionTypeIndention,
  TypeAliasDeclaration = 225 | IsTypescript,
  TypeAnnotation = 226 | IsTypescript,
  TypeArguments = 227 | IsTypescript,
  TypeAssertion = 228 | IsExpression | IsTypescript | IsUntionTypeIndention,
  TypeAssertionExpression = 229 | IsExpression | IsTypescript,
  TypeLiteral = 230 | IsTypescript | IsObjectType,
  TypeOperator = 231 | IsTypescript,
  TypeParameter = 232 | IsTypescript | IsUntionTypeIndention,
  TypeParameterList = 233 | IsTypescript | IsUntionTypeIndention,
  TypePredicate = 234 | IsTypescript,
  TypeQuery = 235 | IsTypescript,
  TypeReference = 236 | IsTypescript | IsUntionTypeIndention,
  ...
  VariableDeclaration = 243 | CanNotBreakeObjectPattern,
...
export const enum NodeFlags {
   ...
   */
  ContainsInvalidEscape = 1 << 21,

  /**
   * This node contains extended unicode escape
   */
  ExtendedUnicodeEscape = 1 << 22,
   ...
   */
  EscapedKeywordOrIdentifier = 1 << 26,
